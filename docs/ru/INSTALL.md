...
Для существующей установки обновите рабочую копию, проверьте файлы релиза и запустите обновление через установщик:
...
При запросе выберите сохранение текущей конфигурации. Перед обновлением с v3.0.x удалите IPv6-записи из JSON GeoIP: v3.1 поддерживает только IPv4-записи.
